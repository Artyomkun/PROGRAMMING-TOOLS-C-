...
void CardGame::initializeConsole() {
    SetConsoleOutputCP(65001);
    SetConsoleCP(65001);
}

string CardGame::getCardName(int cardValue) {
    switch (cardValue) {
...
bool CardGame::isValidCard(int cardValue) {
    return cardValue >= MIN_CARD_VALUE && cardValue <= MAX_CARD_VALUE;
}

void CardGame::printGameRules() {
...
void CardGame::processUserInput() {
    int cardValue;
